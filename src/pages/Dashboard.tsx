...
// Lazy load ALL chart components - recharts is ~200KB
  ...
  return (
    <div className="p-6 space-y-6 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Payment Summary - no charts, just stats */}
        ...
        <Card className="border-0 shadow-md overflow-hidden relative ring-1 ring-destructive/20">
          ...
          <CardHeader className="pb-3 relative">
            <CardTitle className="text-lg flex items-center gap-2 text-destructive">
              <div className="p-1.5 rounded-lg bg-gradient-to-br from-red-400 to-rose-600 text-white">
                <AlertCircle className="h-4 w-4" />
              </div>
      ...
      {/* All Charts - Lazy loaded separately so stats render instantly */}
      <Suspense fallback={<WidgetFallback />}>
