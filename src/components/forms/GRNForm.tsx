          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-3 p-3 bg-gray-50 dark:bg-gray-800 font-medium text-sm rounded-lg" style={{ gridTemplateColumns: '1.2fr 0.7fr 0.9fr minmax(15ch, 1.2fr) minmax(12ch, 1.4fr) 1.2fr 1fr 0.7fr 1fr 0.6fr' }}>
                  <div>Item</div>
...
style={{ gridTemplateColumns: '1.2fr 0.7fr 0.9fr minmax(15ch, 1.2fr) minmax(12ch, 1.4fr) 1.2fr 1fr 0.7fr 1fr 0.6fr' }}
                    >
