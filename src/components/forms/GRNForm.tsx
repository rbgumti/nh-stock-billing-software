...
export function GRNForm({ onClose, onSubmit, purchaseOrder, stockItems }: GRNFormProps) {
  ...
  // NOTE: We intentionally compute totals/status per *PO line item* (not per stockItemId).
  // If the same stockItemId appears multiple times in the PO, grouping by stockItemId
  // would incorrectly make the "total received" look doubled.
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-3 p-3 bg-gray-50 dark:bg-gray-800 font-medium text-sm rounded-lg" style={{ gridTemplateColumns: '1.2fr 0.6fr 1.3fr minmax(15ch, 1.2fr) minmax(16ch, 1.8fr) 1.2fr 1fr 0.7fr 1fr 0.6fr' }}>
                  <div>Item</div>
...
style={{ gridTemplateColumns: '1.2fr 0.6fr 1.3fr minmax(15ch, 1.2fr) minmax(16ch, 1.8fr) 1.2fr 1fr 0.7fr 1fr 0.6fr' }}
                    >
