  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div ref={printRef} className="p-6 bg-white text-black flex flex-col" style={{ fontFamily: "'Segoe UI', Arial, sans-serif", fontSize: '15pt', lineHeight: '1.55', fontWeight: '600', height: '1123px' }}>
          {/* Header with Logo */}
          <div className="text-center mb-4 pb-3 border-b-4" style={{ borderBottomStyle: 'double', borderColor: '#003366' }}>
            <div className="flex justify-center mb-2">
              <img src={navjeevanLogo} alt="Logo" className="w-18 h-18 object-contain" style={{ width: '72px', height: '72px' }} />
            </div>
            <h1 className="text-4xl font-black tracking-wide" style={{ color: '#003366', letterSpacing: '1px' }}>
              NAVJEEVAN HOSPITAL
            </h1>
            <p className="text-base font-bold italic text-gray-700 mt-1">Healthcare with Compassion</p>
            <p className="text-base font-bold text-gray-800">
              Opp. Bus Stand, Vill Bara Sirhind, Distt. Fatehgarh Sahib (Punjab)
            </p>
            <p className="text-base font-bold text-gray-700">Phone: 6284942412 | {doctorName} | Licence No: PSMHC/Pb./2024/863</p>
          </div>
          ...
          {/* PO Info Grid */}
          <div className="grid grid-cols-2 gap-4 mb-4 p-4 rounded-lg text-lg font-bold" style={{ backgroundColor: '#f0f7ff', border: '2px solid #003366' }}>
            <div className="flex">
              <span className="font-black min-w-[130px]" style={{ color: '#003366' }}>PO Number:</span>
              <span className="font-black text-gray-900">{poNumber}</span>
            </div>
            <div className="flex">
              <span className="font-black min-w-[130px]" style={{ color: '#003366' }}>PO Date:</span>
          ...
          <div className="p-4 mb-4 rounded-lg text-lg" style={{ backgroundColor: '#e8f4fd', border: '2px solid #0066cc' }}>
            ...
            <p className="text-gray-800 font-bold text-base mt-1">E-9, INDUSTRIAL AREA SIIDCUL, SILAQULI, DEHRADUN UTTARAKHAND</p>
          </div>
          ...
          {/* Items Table */}
          <table className="w-full border-collapse mb-4 text-lg" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
            <thead>
              <tr style={{ backgroundColor: '#003366' }}>
                <th className="p-3 text-center text-white font-black border border-gray-400 w-[6%]">Sr.</th>
                <th className="p-3 text-left text-white font-black border border-gray-400 w-[18%]">Product</th>
                <th className="p-3 text-left text-white font-black border border-gray-400 w-[36%]">Compositions</th>
              ...
              {items.map((item, index) => {
                ...
                return (
                  <tr key={index} style={{ backgroundColor: index % 2 === 0 ? '#ffffff' : '#f0f7ff' }}>
                    ...
                    <td className="border border-gray-400 p-3 font-bold text-gray-800 text-base">{stockItem?.composition || '-'}</td>
          ...
          {/* Signature Section */}
          <div className="mt-4 flex justify-between text-lg px-2">
            <div className="text-left">
              ...
              <div className="pt-2 border-t-2 border-gray-600 min-w-[240px]">
                <span className="font-black text-gray-900 text-xl">{doctorName}</span>
            ...
            <div className="text-center min-w-[180px]">
              ...
              <div className="pt-2 border-t-2 border-gray-600">
                <span className="font-black text-gray-900 text-xl">Date: {formatDate(poDate)}</span>
              </div>
            </div>
          </div>
          ...
          {/* Footer */}
          <div className="mt-4 text-center text-base font-black pt-3" style={{ borderTop: '3px solid #003366' }}>
