  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div ref={printRef} className="p-5 bg-white text-black flex flex-col" style={{ fontFamily: "'Segoe UI', Arial, sans-serif", fontSize: '13pt', lineHeight: '1.45', fontWeight: '600', height: '1123px' }}>
          {/* Header with Logo */}
          ...
          <div className="p-2 mb-2 rounded-lg text-sm" style={{ backgroundColor: '#e8f4fd', border: '2px solid #0066cc' }}>
            ...
            <p className="text-gray-800 font-bold text-xs">E-9, INDUSTRIAL AREA SIIDCUL, SILAQULI, DEHRADUN UTTARAKHAND</p>
          </div>

          {/* Subject & Salutation */}
          <p className="text-sm font-bold mb-0.5"><span className="font-black" style={{ color: '#003366' }}>Subject:</span> <span className="text-gray-900">Purchase Order</span></p>
          <p className="text-sm font-bold mb-1 text-gray-900">Dear Sir/Madam,</p>
          <p className="text-xs font-semibold text-justify mb-2 text-gray-800" style={{ lineHeight: '1.35' }}>
              ...
              {items.map((item, index) => {
                ...
                return (
                  <tr key={index} style={{ backgroundColor: index % 2 === 0 ? '#ffffff' : '#f0f7ff' }}>
                    ...
                    <td className="border border-gray-400 p-1.5 font-bold text-gray-800 text-xs">{stockItem?.composition || '-'}</td>
          ...
          <div className="mt-2 flex justify-between text-sm">
            ...
            <div className="text-center min-w-[140px]">
              ...
              <div className="pt-1 border-t-2 border-gray-600">
                <span className="font-black text-gray-900">Date: {formatDate(poDate)}</span>
              </div>
            </div>
          </div>
          ...
          {/* Footer */}
          <div className="mt-2 text-center text-sm font-black pt-2" style={{ borderTop: '3px solid #003366' }}>
