  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div ref={printRef} className="p-5 bg-white text-black flex flex-col" style={{ fontFamily: "'Segoe UI', Arial, sans-serif", fontSize: '12pt', lineHeight: '1.4', fontWeight: '600', minHeight: '1123px', height: '1123px' }}>
          {/* Header with Logo */}
          ...
          {/* PO Info Grid */}
          <div className="grid grid-cols-2 gap-2 mb-3 p-3 rounded-lg text-sm font-bold" style={{ backgroundColor: '#f0f7ff', border: '2px solid #003366' }}>
            <div className="flex">
          ...
          {/* Supplier Box */}
          <div className="p-3 mb-3 rounded-lg text-sm" style={{ backgroundColor: '#e8f4fd', border: '2px solid #0066cc' }}>
          ...
          <p className="text-sm font-bold mb-2 text-gray-900">Dear Sir/Madam,</p>
          <p className="text-sm font-semibold text-justify mb-3 text-gray-800" style={{ lineHeight: '1.35' }}>
          ...
          {/* Undertaking - Only 1 line space from table */}
          <div className="mt-2">
            ...
            {/* Signature Section - Two columns with increased space */}
            <div className="flex justify-between text-sm mt-4">
              ...
              <div className="text-right flex flex-col justify-end">
                ...
                <div className="min-h-[70px]"></div>
                <div className="pt-1 border-t-2 border-gray-600 min-w-[150px]">
