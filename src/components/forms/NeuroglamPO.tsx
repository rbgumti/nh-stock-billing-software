      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div ref={printRef} className="p-6 bg-white text-black flex flex-col" style={{ fontFamily: "'Segoe UI', Arial, sans-serif", fontSize: '12pt', lineHeight: '1.5', fontWeight: '500', minHeight: '1123px', height: '1123px' }}>
          ...
          <div className="p-3 mb-4 rounded-lg text-sm" style={{ backgroundColor: '#f0f7ff', border: '2px solid #0066cc' }}>
            ...
            <span className="font-bold">NEUROGLAM</span>
            <p className="text-gray-700 font-medium mt-1">Village – Ajnoud, Tehsil – Payal, Ludhiana – 141421 (Punjab)</p>
          </div>
          ...
          <div className="mt-auto">
            ...
            <p className="text-xs font-medium text-justify leading-relaxed text-gray-700 mb-1">
            ...
            <p className="text-xs font-medium text-justify leading-relaxed text-gray-700 mb-2">
            ...
            <p className="font-bold text-xs mb-1" style={{ color: '#003366' }}>Neuroglam Liability Acknowledgment:</p>
            ...
            <div className="flex justify-between text-sm px-2">
              <div className="text-left">
                ...
                <div className="mt-16 pt-2 border-t-2 border-gray-500 min-w-[180px]">
              ...
              <div className="text-center min-w-[140px]">
                <div className="mt-16 pt-2 border-t-2 border-gray-500">
