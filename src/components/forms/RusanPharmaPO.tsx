...
export function RusanPharmaPO({ poNumber, poDate, items, stockItems, onClose }: RusanPharmaPOProps) {
  ...
  const handleDownloadPDF = () => {
    ...
    y += 3;
    pdf.setFont('times', 'bold');
    pdf.text('Rusan Pharma Ltd.', 10, y);
    y += 3;
    pdf.setFont('times', 'normal');
    pdf.text('Khasra No. 122MI, Central Hope Town,', 10, y);
    y += 3;
    pdf.text('Selaqui, Dehradun, Uttarakhand-248197', 10, y);
    y += 3;
