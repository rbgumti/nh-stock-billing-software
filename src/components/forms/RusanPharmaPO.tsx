    ...
    return (
      ...
      >
        ...
        {isFirstPage && (
          <>
            <div className="text-center" style={{ marginBottom: '4px' }}>
              <h1 className="font-black" style={{ fontSize: '27pt', color: '#000', letterSpacing: '2px', marginBottom: '0' }}>
                NAVJEEVAN HOSPITAL
              </h1>
              <p className="font-bold italic" style={{ fontSize: '12pt', color: '#333', margin: '0' }}>Healthcare with Compassion</p>
              <p className="font-semibold" style={{ fontSize: '11pt', color: '#333', margin: '2px 0 0 0' }}>
                Opp. Bus Stand, Vill Bara Sirhind, Distt. Fatehgarh Sahib (Punjab)
              </p>
              <p className="font-semibold" style={{ fontSize: '11pt', color: '#333', margin: '0' }}>
            ...
            <div className="text-center" style={{ marginBottom: '10px' }}>
              <h2 className="font-black" style={{ fontSize: '19pt', color: '#003366', letterSpacing: '1px' }}>
            ...
            <p className="font-semibold" style={{ fontSize: '12pt', marginBottom: '4px', color: '#000' }}>
              <span className="font-black">To:</span> RUSAN PHARMA LTD., Khasra No. 122/8, Central Hope Town, Selaqui, Dehradun, Uttarakhand - 248197
            </p>

            {/* Subject & Salutation */}
            <p className="font-black" style={{ fontSize: '12pt', marginBottom: '0', color: '#000' }}>Subject: Purchase Order</p>
            <p className="font-black" style={{ fontSize: '12pt', marginBottom: '4px', color: '#000' }}>Dear Sir/Madam,</p>
            <p className="font-semibold text-justify" style={{ fontSize: '11.5pt', marginBottom: '8px', color: '#000', lineHeight: '1.45' }}>
        ...
        {!isFirstPage && (
          <>
            <div className="text-center" style={{ marginBottom: '4px' }}>
              <h1 className="font-black" style={{ fontSize: '23pt', color: '#000', letterSpacing: '2px' }}>NAVJEEVAN HOSPITAL</h1>
              <p className="font-bold italic" style={{ fontSize: '11pt', color: '#333' }}>Healthcare with Compassion</p>
            </div>
        ...
        {isLastPage && (
          <>
            ...
            <div style={{ marginBottom: '4px' }}>
              <p className="font-black" style={{ color: '#000', fontSize: '12pt', margin: '0' }}>For Navjeevan Hospital,</p>
              <p className="font-semibold" style={{ color: '#333', fontSize: '11pt', margin: '0' }}>Opp. New Bus Stand, G.T. Road, Sirhind</p>
            </div>
            ...
            <div className="flex-grow" style={{ display: 'flex', minHeight: '180px', marginBottom: '6px' }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', padding: '8px' }}>
                <p className="font-semibold" style={{ color: '#555', fontSize: '11pt', textAlign: 'center', margin: '0' }}>Doctor's Signature</p>
                <p className="font-bold" style={{ color: '#000', fontSize: '11pt', textAlign: 'center', margin: '0' }}>({doctorName || 'Dr. Metali Bhatti'})</p>
              </div>
            </div>
          </>
        )}
