  ...
  const renderPage = (pageItems: PurchaseOrderItem[], pageIndex: number, startIndex: number) => {
    ...
    return (
      <div
        ...
        style={{ fontFamily: "'Segoe UI', Arial, sans-serif", fontSize: '14pt', lineHeight: '1.5', fontWeight: '600' }}
      >
        {/* Header with Logo */}
        <div className="text-center mb-4 pb-3 border-b-2" style={{ borderColor: '#003366' }}>
        ...
        <div className="flex justify-center mb-4">
          <div className="px-8 py-2 rounded text-white font-black text-base tracking-widest shadow-sm" style={{ backgroundColor: '#003366' }}>
        ...
        {isFirstPage && (
          <>
            <div className="flex justify-between mb-4 p-3 rounded text-base font-bold" style={{ backgroundColor: '#f0f7ff', border: '2px solid #003366' }}>
              <div>
            ...
            {/* Supplier Box */}
            <div className="p-3 mb-4 rounded text-base" style={{ backgroundColor: '#e8f4fd', border: '2px solid #0066cc' }}>
            ...
            {/* Subject */}
            <p className="text-base mb-1 font-bold">
        ...
        {!isFirstPage && (
          <div className="mb-4 p-3 rounded text-base font-bold" style={{ backgroundColor: '#f0f7ff', border: '2px solid #003366' }}>
            <span className="font-black" style={{ color: '#003366' }}>PO No: </span>
            <span className="font-black text-gray-900">{poNumber}</span>
        ...
        <table className="w-full border-collapse mb-4 text-base">
          <thead>
            <tr style={{ backgroundColor: '#003366' }}>
              <th className="p-2.5 text-center text-white font-black border border-gray-400 w-[8%]">Sr.</th>
              <th className="p-2.5 text-left text-white font-black border border-gray-400 w-[50%]">Product Name</th>
              <th className="p-2.5 text-center text-white font-black border border-gray-400 w-[20%]">Packing</th>
              <th className="p-2.5 text-center text-white font-black border border-gray-400 w-[22%]">Qty.</th>
            </tr>
          </thead>
          <tbody>
        ...
        {isLastPage && (
          <div className="mt-5">
            <div className="pt-2" style={{ borderTop: '2px solid #003366' }}>
            ...
            <div className="flex justify-between text-base mt-3">
              ...
              <div className="text-left">
                ...
                <div className="pt-2 border-t border-gray-600 min-w-[200px]">
              ...
              <div className="text-right flex flex-col justify-end">
                {/* Space for signature */}
                <div className="min-h-[60px]"></div>
                <div className="pt-2 border-t border-gray-600 min-w-[160px]">
