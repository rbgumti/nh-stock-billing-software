        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .ref-po-section { text-align: center; font-size: 12px; margin-bottom: 20px; }
            .to-section { margin-bottom: 15px; font-size: 11px; line-height: 1.6; margin-left: 100px; }
            .subject-section { margin-left: 100px; font-size: 11px; margin-bottom: 15px; }
            table { width: 100%; border-collapse: collapse; margin: 15px 0; font-size: 11px; }
            th, td { border: 1px solid #000; padding: 6px 8px; }
            th { background-color: #f5f5f5; font-weight: bold; text-align: center; }
            td { text-align: left; }
            td.center { text-align: center; }
            .footer-section { font-size: 11px; margin-top: 25px; margin-left: 100px; line-height: 1.8; }
            .signature-section { font-size: 11px; margin-top: 30px; margin-left: 100px; line-height: 1.6; }
            @media print {
