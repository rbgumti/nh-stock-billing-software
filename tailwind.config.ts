	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'glow-emerald': '0 0 30px hsl(var(--emerald) / 0.35)',
				'glow-gold': '0 0 30px hsl(var(--gold) / 0.35)',
				'glow-purple': '0 0 30px hsl(var(--purple) / 0.35)',
				'soft': '0 4px 20px hsl(var(--primary) / 0.15)',
				'soft-lg': '0 8px 40px hsl(var(--primary) / 0.2)'
			},
			keyframes: {
				'accordion-down': {
					from: { height: '0' },
